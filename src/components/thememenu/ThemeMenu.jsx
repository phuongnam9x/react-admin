...
import ThemeActive from '../../redux/actions/ThemeAction'
...
const ThemeMenu = () => {
    ...
    const setMode = mode => {
        ...
        dispatch(ThemeActive.setMode(mode.class))
    }

    const setcolor = color => {
        setcurrColor(color.id)
        localStorage.setItem('colorNode', color.class)
        dispatch(ThemeActive.setColor(color.class))
